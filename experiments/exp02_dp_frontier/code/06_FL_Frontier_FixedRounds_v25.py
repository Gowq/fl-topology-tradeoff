#!/usr/bin/env python3
"""Exp06 diagnostic: fixed-round DP frontier tail.
...
def output_paths(part: str, smoke_only: bool) -> tuple[Path, Path]:
    ...
    out_path = results_dir / f"exp06_fixed_rounds_{suffix}.json"
    partial_path = results_dir / f"partial_exp06_fixed_rounds_{suffix}.json"
...
def main() -> int:
    ...
    print("=== Exp06 fixed-round frontier diagnostic ===")
