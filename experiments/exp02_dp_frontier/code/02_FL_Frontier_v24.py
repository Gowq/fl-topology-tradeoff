#!/usr/bin/env python3
"""Exp02 — Extended privacy-utility frontier.
...
Output: results/dp_frontier_eps10-200.json
...
def main():
    ...
    out_path     = Path("results/dp_frontier_eps10-200.json")
    partial_path = Path("results/partial_dp_frontier_eps10-200.json")
    ...
    print(f"=== Exp02 FRONTIER: OPPORTUNITY × {{HFL, VFL}} × {{Inter, Late}} × ε={FRONTIER_EPSILONS} ===")
